<?php
/*
Plugin Name: M2ThemeWizard
Plugin URI:
Description: Monstroid2 theme installation wizard.
Author: Zemez
Author URI:
Version: 1.0.0
Text Domain: m2-theme-wizard
...
if ( ! class_exists( 'M2_Theme_sWizard' ) ) {

	/**
	 * Define M2_Theme_Wizard class
	 */
	class M2_Theme_Wizard {
		 ...
		 * @var string
		 */
		private $slug = 'm2-theme-wizard';

		/**
		 * Nonce action name.
		 * @var string
		 */
		public $_nonce = 'm2-theme-wizard-nonce';
		 ...
		 * @var string
		 */
		public $prefix = 'm2_theme_wizard_';
		...
		function __construct() {
			...
			$this->settings = array(
				'options' => array(
					'parent_data' => 'm2-theme-wizard-installed-parent',
					'child_data'  => 'm2-theme-wizard-installed-child',
				),
			);
		...
		public function hooks() {
			...
			add_action( 'admin_menu', array( m2_theme_interface(), 'register_page' ) );
			add_action( 'admin_menu', array( m2_theme_interface(), 'register_page' ) );
		}
		...
		public function lang() {
			load_plugin_textdomain( 'm2-theme-wizard', false, $this->path( 'languages' ) );
		}
		...
		public function activation_redirect() {
			...
			$enbled = apply_filters( 'm2-theme-wizard/activation-redirect-enabled', $enbled );
			...
			delete_transient( $this->slug() . '_redirect' );
			wp_redirect( m2_theme_interface()->get_page_link() );
			die();
		}
		...
		public function enqueue_assets( $hook ) {
			...
			wp_localize_script( $this->slug(), 'JetThemeWizardSettings', array(
				...
				'errors' => array(
					'empty' => esc_html__( '* Please, fill this field', 'm2-theme-wizard' ),
				),
			) );
			 ...
			 */
			do_action( 'm2-theme-wizard/enqueue-assets' );
		}
...
/**
 * Returns instance of M2_Theme_Wizard
 *
 * @return object
 */
function m2_theme_wizard() {
	return M2_Theme_Wizard::get_instance();
}
